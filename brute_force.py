...
def calculate_distance(first_point, second_point):
    distance = math.sqrt(math.fabs((first_point[1] - second_point[1])**2 + (first_point[0] - second_point[0])**2))
    return distance
...
def main():
    try:
        ...
        print("Error parsing arguments--need to call with 'python3 ./brute_force.py $INPUT_FILE $OUTPUT_FILE'")
        exit()
